...
public class DoubleListScale2Serializer extends JsonSerializer<List<Double>> {
    ...
    public void serialize(List<Double> value, JsonGenerator gen, SerializerProvider provider)
        ...
        if (value != null) {
            ...
            for (int i = 0; i < value.size(); i++) {
                newValue[i] = new BigDecimal(value.get(i).toString()).setScale(2, BigDecimal.ROUND_HALF_UP).doubleValue();
            }

package com.cj.biz.core.config;
...
import com.cj.biz.core.handler.GlobalExceptionUtil;
...
public class GlobalConfigure implements WebMvcConfigurer {
    ...
    public Docket appApiDoc() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .groupName(FeignConstant.BIZ_APP)
                .select()
                .apis(RequestHandlerSelectors.withMethodAnnotation(ApiOperation.class))
                .apis(RequestHandlerSelectors.basePackage("com.cj"))
                .paths(PathSelectors.any())
                .build().extensions(openApiExtensionResolver.buildExtensions(FeignConstant.BIZ_APP));
    }

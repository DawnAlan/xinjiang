package com.cj.fourPredictions.core.config;
...
import com.cj.fourPredictions.core.handler.GlobalExceptionUtil;
    ...
    public Docket appApiDoc() {
        return new Docket(DocumentationType.SWAGGER_2)
                .apiInfo(new ApiInfoBuilder()
                        .title(FeignConstant.FOUR_PREDICTIONS_APP)
                        .description(FeignConstant.FOUR_PREDICTIONS_APP)
                ...
                .groupName(FeignConstant.FOUR_PREDICTIONS_APP)
                .select()
                .apis(RequestHandlerSelectors.withMethodAnnotation(ApiOperation.class))
                .apis(RequestHandlerSelectors.basePackage("com.cj"))
                .paths(PathSelectors.any())
                .build().extensions(openApiExtensionResolver.buildExtensions(FeignConstant.FOUR_PREDICTIONS_APP));
    }

package com.cj.approval.core.config;
...
import com.cj.approval.core.handler.GlobalExceptionUtil;
    ...
    public Docket appApiDoc() {
        return new Docket(DocumentationType.SWAGGER_2)
                .apiInfo(new ApiInfoBuilder()
                        .title(FeignConstant.APPROVAL_APP)
                        .description(FeignConstant.APPROVAL_APP)
                ...
                .groupName(FeignConstant.APPROVAL_APP)
                .select()
                .apis(RequestHandlerSelectors.withMethodAnnotation(ApiOperation.class))
                .apis(RequestHandlerSelectors.basePackage("com.cj"))
                .paths(PathSelectors.any())
                .build().extensions(openApiExtensionResolver.buildExtensions(FeignConstant.APPROVAL_APP));
    }

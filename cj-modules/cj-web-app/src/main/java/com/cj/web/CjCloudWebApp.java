...
public class CjCloudWebApp {
    ...
    public static void main(String[] args) {
        SpringApplication springApplication = new SpringApplication(CjCloudWebApp.class);
        springApplication.run(args);
        log.info(">>> {}", CjCloudWebApp.class.getSimpleName().toUpperCase() + " STARTING SUCCESS");
    }

package com.cj.flood.core.config;
...
import com.cj.flood.core.handler.GlobalExceptionUtil;
    ...
    public Docket appApiDoc() {
        return new Docket(DocumentationType.SWAGGER_2)
                .apiInfo(new ApiInfoBuilder()
                        .title(FeignConstant.FLOOD_APP)
                        .description(FeignConstant.FLOOD_APP)
                ...
                .groupName(FeignConstant.FLOOD_APP)
                .select()
                .apis(RequestHandlerSelectors.withMethodAnnotation(ApiOperation.class))
                .apis(RequestHandlerSelectors.basePackage("com.cj"))
                .paths(PathSelectors.any())
                .build().extensions(openApiExtensionResolver.buildExtensions(FeignConstant.FLOOD_APP));
    }

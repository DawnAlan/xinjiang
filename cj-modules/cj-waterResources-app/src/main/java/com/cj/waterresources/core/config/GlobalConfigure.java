package com.cj.waterresources.core.config;
...
import com.cj.waterresources.core.handler.GlobalExceptionUtil;
    ...
    public Docket appApiDoc() {
        return new Docket(DocumentationType.SWAGGER_2)
                .apiInfo(new ApiInfoBuilder()
                        .title(FeignConstant.WATER_RESOURCES_APP)
                        .description(FeignConstant.WATER_RESOURCES_APP)
                ...
                .groupName(FeignConstant.WATER_RESOURCES_APP)
                .select()
                .apis(RequestHandlerSelectors.withMethodAnnotation(ApiOperation.class))
                .apis(RequestHandlerSelectors.basePackage("com.cj"))
                .paths(PathSelectors.any())
                .build().extensions(openApiExtensionResolver.buildExtensions(FeignConstant.WATER_RESOURCES_APP));
    }

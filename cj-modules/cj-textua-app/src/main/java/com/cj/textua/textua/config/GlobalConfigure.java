...
package com.cj.textua.textua.config;
...
import com.cj.textua.textua.handler.GlobalExceptionUtil;
    ...
    public Docket appApiDoc() {
        return new Docket(DocumentationType.SWAGGER_2)
                .apiInfo(new ApiInfoBuilder()
                        .title(FeignConstant.TEXTUA_APP)
                        .description(FeignConstant.TEXTUA_APP)
                ...
                .groupName(FeignConstant.TEXTUA_APP)
                .select()
                .apis(RequestHandlerSelectors.withMethodAnnotation(ApiOperation.class))
                .apis(RequestHandlerSelectors.basePackage("com.cj"))
                .paths(PathSelectors.any())
                .build()
                .extensions(openApiExtensionResolver.buildExtensions(FeignConstant.TEXTUA_APP));
    }

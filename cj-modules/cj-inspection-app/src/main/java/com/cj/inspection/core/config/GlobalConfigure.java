package com.cj.inspection.core.config;
...
import com.cj.inspection.core.handler.GlobalExceptionUtil;
    ...
    public Docket appApiDoc() {
        return new Docket(DocumentationType.SWAGGER_2)
                .apiInfo(new ApiInfoBuilder()
                        .title(FeignConstant.INSPECTION_APP)
                        .description(FeignConstant.INSPECTION_APP)
                ...
                .groupName(FeignConstant.INSPECTION_APP)
                .select()
                .apis(RequestHandlerSelectors.withMethodAnnotation(ApiOperation.class))
                .apis(RequestHandlerSelectors.basePackage("com.cj"))
                .paths(PathSelectors.any())
                .build().extensions(openApiExtensionResolver.buildExtensions(FeignConstant.INSPECTION_APP));
    }

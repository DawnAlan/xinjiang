...
//           waterDemand=req.getWaterDemand_month();
...
//      楼庄子来水预报
//        inflow1[0]=new double[]{2.054,1.765,2.605,3.818,5.537,19.364,16.912,9.932,5.083,3.515,2.101,1.581};
//      头屯河来水预报
//        inflow1[1]=new double[]{0.254,0,0.237,0,0,1.322,2.384,0,0,0,1.053,0.459};
//      楼庄子水厂
        waterDemand1[0]= new double[]{0,0,0,0,0,0,247.99,248,239.99,248.01,239.99,247.99};
//      红岩取水
        waterDemand1[1]= new double[]{36.75,32.25,40.05,172.29,451.97,631.12,708.23,572.33,326.75,360.91,57.15,37.07};
//      八钢工业
        waterDemand1[2]= new double[]{15.58,13.67,16.98,73.05,191.64,267.60,300.29,242.67,138.54,153.03,24.23,15.72};
//
        waterDemand1[3]= new double[]{70.15,61.55,76.45,328.82,862.59,1204.52,1351.68,1092.31,623.62,688.8,109.07,70.76};
        waterDemand1[4]= new double[]{70.15,61.55,76.45,328.82,862.59,1204.52,1351.68,1092.31,623.62,688.8,109.07,70.76};

//        西干
//        水管站
        waterdemand31[0]= new double[]{16.97,14.89,18.49,79.54,208.66,291.37,326.97,264.23,150.85,166.62,26.38,17.12};
//        三工镇1
        waterdemand31[1]= new double[]{14.04,12.32,15.30,65.8,172.61,241.02,270.47,218.57,124.79,137.83,21.82,14.16};
//        六工镇1
        waterdemand31[2]= new double[]{19.64,17.23,21.40,92.07,241.53,337.27,378.47,305.85,174.61,192.87,30.54,19.81};
//        用水协会1
        waterdemand31[3]= new double[]{12.49,10.96,13.61,58.53,153.54,214.4,240.6,194.43,111,122.61,19.41,12.59};
//        园艺场1
        waterdemand31[4]=new double[]{4.91,4.31,5.35,23.02,60.38,84.32,94.62,76.46,43.65,48.22,7.63,4.95};
//        城绿化1
        waterdemand31[5]=new double[]{2.1,1.85,2.29,9.86,25.88,36.14,40.55,32.77,18.71,20.66,3.27,2.12};

//        东干
//        灯笼渠
        waterdemand41[0]= new double[]{8,7.02,8.71,37.49,98.34,137.32,154.09,124.52,71.09,78.52,12.43,8.07};
//        头屯河1
        waterdemand41[1]= new double[]{11.52,10.11,12.55,53.98,141.62,197.75,221.91,179.33,102.38,113.08,17.91,11.62};
//        三坪1
        waterdemand41[2]= new double[]{27.63,24.25,30.11,129.53,339.79,474.48,532.45,430.28,245.65,271.33,42.96,27.87};
//        五一1
        waterdemand41[3]= new double[]{13.07,11.47,14.24,61.27,160.72,224.43,251.85,203.53,116.2,128.34,20.32,13.18};

//        西缘1
        waterdemand41[4]= new double[]{3.55,3.12,3.87,16.66,43.72,61.04,68.5,55.36,31.6,34.91,5.53,3.59};
//        格信1
        waterdemand41[5]= new double[]{3.14,2.76,3.43,14.74,38.67,54,60.6,48.97,27.96,30.88,4.89,3.17};
//        机关绿化1
        waterdemand41[6]= new double[]{1.97,1.73,2.15,9.24,24.23,33.83,37.96,30.68,17.52,19.35,3.06,1.99};
//        水管站1
        waterdemand41[7]= new double[]{1.26,1.11,1.37,5.91,15.51,21.66,24.31,19.65,11.22,12.39,1.96,1.27};

...
//       河东绿化细分
        ...
        copyRowRange(waterDemand1,waterDemand,xnum,xnum+1);
        copyRowRange(waterdemand31,waterdemand3,xnum,xnum+1);
        copyRowRange(waterdemand41,waterdemand4,xnum,xnum+1);
        copyRowRange(waterDemandIndustryQushou1,waterDemandIndustryQushou,xnum,xnum+1);
        copyRowRange(waterDemandGreenEast1,waterDemandGreenEast,xnum,xnum+1);
        copyRowRange(waterDemandGreenWest1,waterDemandGreenWest,xnum,xnum+1);
        copyRowRange(waterDemandGreenQushou1,waterDemandGreenQushou,xnum,xnum+1);

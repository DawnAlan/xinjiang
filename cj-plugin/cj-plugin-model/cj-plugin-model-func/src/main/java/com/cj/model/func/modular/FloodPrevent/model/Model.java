...
public class Model {
    ...
    public static double[] ConventionalCalculate(Reservoir reservoir,double level,double input,double interval,double nextInput,double nextInterval,double lastOut,double lastH,double minQ){
        //流量数组

...
public class MachineModel {
     ...
     */
    public List<TemporaryXlsx> modelTrain(Object[][] modelTrainInput, ForecastInputParam param) throws IOException, InvalidFormatException
    {
...
//        Trainresult(de_result, reaResult, preResult, vmdreaResult, pvo);
    ...
    public static ForecastInputParam paramSet (Object[][] modelTrainInput, ForecastInputParam param) {
        ...
        param.setMaxRate(0.032);//这个会影响精度！！!
        String layers = param.getHistory_day() +",11,11,1";//，输入前几个时段径流，k为输入的因素数量输出未来流量

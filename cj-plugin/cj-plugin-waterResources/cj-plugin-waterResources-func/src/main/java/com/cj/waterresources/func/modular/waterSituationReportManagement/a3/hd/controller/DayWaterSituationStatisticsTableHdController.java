...
public class DayWaterSituationStatisticsTableHdController {
    ...
    @ApiOperation("河东管理站日水情统计表新增")
    @CommonLog("河东管理站日水情统计表新增")
    @PostMapping("/add")
    ...
    @ApiOperation("河东管理站日水情统计表查询列表")
    @CommonLog("河东管理站日水情统计表查询列表")
    ...
    @ApiOperation("河东管理站日水情统计表删除")
    @CommonLog("河东管理站日水情统计表删除")
    @GetMapping("/delete")
    ...
    @ApiOperation("河东管理站日水情统计表修改")
    @CommonLog("河东管理站日水情统计表修改")
    @PostMapping("/update")

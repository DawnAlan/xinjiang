...
public class WaterFeeStatisticsDetailsServiceImpl extends ServiceImpl<WaterFeeStatisticsDetailsMapper, WaterFeeStatisticsDetails> implements WaterFeeStatisticsDetailsService {
        ...
        if (b) {
            ...
            if(null != tempList && tempList.size()>0){
                ...
                if(tempObj.getStation().contains("绿化") || tempObj.getStation().contains("砂厂")){
                    ...
                    for(WaterFeeStatisticsTotal total :waterFeeStatisticsTotalList){
                        ...
                        List<PaymentWaterFees> list1 = paymentWaterFeesService.lambdaQuery().eq(PaymentWaterFees::getDel,0).
                                ...
                                eq(PaymentWaterFees::getWaterUserId, total.getTableHeadId()).eq(PaymentWaterFees::getType,"水资源费").
                                apply("PAYMENT_TIME BETWEEN '"+timeRange.get("startTime")+"' and '"+timeRange.get("endTime")+"'").list();
                        if(null != list1 && list1.size()>0){
                            ...
                            if(!byId1.getPId().equals("0")){
                                ...
                                List<PaymentWaterFees> list2 = paymentWaterFeesService.lambdaQuery().eq(PaymentWaterFees::getDel,0).
                                        ...
                                        eq(PaymentWaterFees::getWaterUserId, one.getId()).eq(PaymentWaterFees::getType,"水资源费").
                                        apply("PAYMENT_TIME BETWEEN '"+timeRange.get("startTime")+"' and '"+timeRange.get("endTime")+"'").list();
                            ...
                            if(byId.getPId().equals("0")){
                               ...
                               /* List<String> collect1 = trendsTableParamService.lambdaQuery().
                                ...
                                List<PaymentWaterFees> paymentWaterFees = paymentWaterFeesService.lambdaQuery().eq(PaymentWaterFees::getDel,0).
                                        ...
                                        in(PaymentWaterFees::getWaterUserId, collect1).eq(PaymentWaterFees::getType,"水资源费").
                                        apply("PAYMENT_TIME BETWEEN '"+timeRange.get("startTime")+"' and '"+timeRange.get("endTime")+"'").list();
                                ...
                                if(null != collect1 && collect1.size()>0){
                                    ...
                                    if(null != collect2 && collect2.size()>0){
                                        List<PaymentWaterFees> paymentWaterFees2 = paymentWaterFeesService.lambdaQuery().eq(PaymentWaterFees::getDel,0).
                                                ...
                                                in(PaymentWaterFees::getWaterUserId, collect2).eq(PaymentWaterFees::getType,"水资源费").
                                                apply("PAYMENT_TIME BETWEEN '"+timeRange.get("startTime")+"' and '"+timeRange.get("endTime")+"'").list();
                                    ...
                                    if(null != collect2 && collect2.size()>0){
                                        ...
                                        if(null != collect3 && collect3.size()>0){
                                            List<PaymentWaterFees> paymentWaterFees3= paymentWaterFeesService.lambdaQuery().eq(PaymentWaterFees::getDel,0).
                                                    ...
                                                    in(PaymentWaterFees::getWaterUserId, collect3).eq(PaymentWaterFees::getType,"水资源费").
                                                    apply("PAYMENT_TIME BETWEEN '"+timeRange.get("startTime")+"' and '"+timeRange.get("endTime")+"'").list();
                            ...
                            if(!byId.getPId().equals("0")){
                                ...
                                if(null!= collect1Son && collect1Son.size()>0){
                                    List<PaymentWaterFees> paymentWaterFeesSon = paymentWaterFeesService.lambdaQuery().eq(PaymentWaterFees::getDel,0).
                                            ...
                                            in(PaymentWaterFees::getWaterUserId, collect1Son).eq(PaymentWaterFees::getType,"水资源费").
                                            apply("PAYMENT_TIME BETWEEN '"+timeRange.get("startTime")+"' and '"+timeRange.get("endTime")+"'").list();
                                ...
                                if(null != paymentWaterFees && paymentWaterFees.size()>0){
                                    ...
                                    List<PaymentWaterFees> paymentWaterFees2 = paymentWaterFeesService.lambdaQuery().eq(PaymentWaterFees::getDel,0).
                                            ...
                                            in(PaymentWaterFees::getWaterUserId, byId.getPId()).eq(PaymentWaterFees::getType,"水资源费").
                                            apply("PAYMENT_TIME BETWEEN '"+timeRange.get("startTime")+"' and '"+timeRange.get("endTime")+"'").list();
                                    if(null != paymentWaterFees2 && paymentWaterFees2.size()>0){
                                        for(PaymentWaterFees fees:paymentWaterFees2){
                                            paidWaterResourceCount+=fees.getPaymentAmount();
                ...
                for(WaterFeeStatisticsTotal total :waterFeeStatisticsTotalList){
                    ...
                    List<PaymentWaterFees> list1 = paymentWaterFeesService.lambdaQuery().eq(PaymentWaterFees::getDel,0).
                            eq(PaymentWaterFees::getWaterUserId, total.getTableHeadId()).eq(PaymentWaterFees::getType,"水费").
                            apply("PAYMENT_TIME BETWEEN '"+timeRange.get("startTime")+"' and '"+timeRange.get("endTime")+"'").list();
                    if(null != list1 && list1.size()>0){
                        for(PaymentWaterFees fees:list1){
                        ...
                        if(!byId1.getPId().equals("0")){
                            ...
                            List<PaymentWaterFees> list2 = paymentWaterFeesService.lambdaQuery().eq(PaymentWaterFees::getDel,0).
                                    ...
                                    eq(PaymentWaterFees::getWaterUserId, one.getId()).eq(PaymentWaterFees::getType,"水费").
                                    apply("PAYMENT_TIME BETWEEN '"+timeRange.get("startTime")+"' and '"+timeRange.get("endTime")+"'").list();
                            if(null!=list2 && list2.size()>0){
                                for(PaymentWaterFees fees:list2){
                    ...
                    for(String id:totalColl){
                        ...
                        if(byId.getPId().equals("0")){
                            ...
                            List<PaymentWaterFees> paymentWaterFees = paymentWaterFeesService.lambdaQuery().eq(PaymentWaterFees::getDel,0).
                                    ...
                                    in(PaymentWaterFees::getWaterUserId, collect1).eq(PaymentWaterFees::getType,"水费").
                                    apply("PAYMENT_TIME BETWEEN '"+timeRange.get("startTime")+"' and '"+timeRange.get("endTime")+"'").list();
                            if(null != paymentWaterFees && paymentWaterFees.size()>0){
                                for(PaymentWaterFees fees:paymentWaterFees){
                            ...
                            if(null != collect1 && collect1.size()>0){
                                ...
                                if(null != collect2 && collect2.size()>0){
                                    List<PaymentWaterFees> paymentWaterFees2 = paymentWaterFeesService.lambdaQuery().eq(PaymentWaterFees::getDel,0).
                                            ...
                                            in(PaymentWaterFees::getWaterUserId, collect2).eq(PaymentWaterFees::getType,"水费").
                                            apply("PAYMENT_TIME BETWEEN '"+timeRange.get("startTime")+"' and '"+timeRange.get("endTime")+"'").list();
                                    if(null != paymentWaterFees2 && paymentWaterFees2.size()>0){
                                        for(PaymentWaterFees fees:paymentWaterFees2){
                                            advancePaymentWaterFeeCount+=fees.getPaymentAmount();
                                ...
                                if(null != collect2 && collect2.size()>0){
                                    ...
                                    if(null != collect3 && collect3.size()>0){
                                        List<PaymentWaterFees> paymentWaterFees3= paymentWaterFeesService.lambdaQuery().eq(PaymentWaterFees::getDel,0).
                                                ...
                                                in(PaymentWaterFees::getWaterUserId, collect3).eq(PaymentWaterFees::getType,"水费").
                                                apply("PAYMENT_TIME BETWEEN '"+timeRange.get("startTime")+"' and '"+timeRange.get("endTime")+"'").list();
                                        if(null != paymentWaterFees3 && paymentWaterFees3.size()>0){
                                            for(PaymentWaterFees fees:paymentWaterFees3){
                                                advancePaymentWaterFeeCount+=fees.getPaymentAmount();
                        ...
                        if(!byId.getPId().equals("0")){
                            ...
                            if(null!= collect1Son && collect1Son.size()>0){
                                List<PaymentWaterFees> paymentWaterFeesSon = paymentWaterFeesService.lambdaQuery().eq(PaymentWaterFees::getDel,0).
                                        ...
                                        in(PaymentWaterFees::getWaterUserId, collect1Son).eq(PaymentWaterFees::getType,"水费").
                                        apply("PAYMENT_TIME BETWEEN '"+timeRange.get("startTime")+"' and '"+timeRange.get("endTime")+"'").list();
                                paymentWaterFees.addAll(paymentWaterFeesSon);
                            }
                            if(null != paymentWaterFees && paymentWaterFees.size()>0){
                                ...
                                List<PaymentWaterFees> paymentWaterFees2 = paymentWaterFeesService.lambdaQuery().eq(PaymentWaterFees::getDel,0).
                                        ...
                                        in(PaymentWaterFees::getWaterUserId, byId.getPId()).eq(PaymentWaterFees::getType,"水费").
                                        apply("PAYMENT_TIME BETWEEN '"+timeRange.get("startTime")+"' and '"+timeRange.get("endTime")+"'").list();
                                if(null != paymentWaterFees2 && paymentWaterFees2.size()>0){
                                    for(PaymentWaterFees fees:paymentWaterFees2){
                                        advancePaymentWaterFeeCount+=fees.getPaymentAmount();
    ...
    public RestResponse update(List<WaterFeeStatisticsDetails> waterFeeStatisticsDetails) {
        ...
        if(restResponse.getCode()==200){
            ...
            Double waterResourceSurplusCount = 0.0;
            WaterFeeStatisticsDetails tempObj = waterFeeStatisticsDetails.get(0);
            Map<String, String> timeRange = getTimeRange(tempObj.getYear(), tempObj.getMonth(), tempObj.getTenDays());
            ...
            if(null != listTotalIdToStation && listTotalIdToStation.size()>0){
                Double payableWaterFeeAllCount = 0.0;
                Double unpaidWaterFeesAllCount = 0.0;
                Double payableWaterResource = 0.0;
                Double waterResourceSurplus = 0.0;
                List<String> totalColl = listTotalIdToStation.stream().filter(t->t.getName().equals("合计")).map(TotalIdToStation::getTotalId).collect(Collectors.toList());
                for(String id:totalColl){
                    TrendsTableParam byId = JSONObject.parseObject((String)redisUtil.get("trendsTableParam:object:"+id),TrendsTableParam.class);
                    if(byId.getPId().equals("0")){
                        for(WaterFeeStatisticsTotal total:waterFeeStatisticsTotalList){
                            if(!totalColl.contains(total.getTableHeadId())){
                                payableWaterFeeAllCount += total.getPayableWaterFee();
                                unpaidWaterFeesAllCount += total.getUnpaidWaterFees();
                                payableWaterResource += total.getPayableWaterResource()==null?0.0:total.getPayableWaterResource();
                                waterResourceSurplus += total.getWaterResourceSurplus()==null?0.0:total.getWaterResourceSurplus();
                            }
                        }
                        for(WaterFeeStatisticsTotal total:waterFeeStatisticsTotalList){
                            if(id.equals(total.getTableHeadId())){
                                total.setPayableWaterFee(payableWaterFeeAllCount);
                                total.setUnpaidWaterFees(unpaidWaterFeesAllCount);
                                total.setPayableWaterResource(payableWaterResource);
                                total.setWaterResourceSurplus(waterResourceSurplus);
                                total.setWaterResourceTotal(total.getUnpaidWaterFees()+total.getWaterResourceSurplus());
                            }
                        }
                    }
                ...
                waterFeeStatisticsDetails.forEach(t->{
                    if(!sdf.format(new Date()).equals(dateTemp)){
                        ...
                        if(!paramName.equals("合计")){
                            ...
                            TrendsTableParam tableParam = JSONObject.parseObject(tableParamString, TrendsTableParam.class);
                            if(t.getStation().contains("河东")){
                                Optional<String> first = trendsTableParamListTemp.stream().filter(p ->p.getUseStation().contains("河东") && p.getUseType() == 1 && p.getUnitId() != null && p.getUnitId().equals(tableParam.getUnitId())).map(TrendsTableParam::getId).findFirst();
                                String s = StringUtils.isEmpty(first.orElse(""))?"":first.get();
                                Double aDouble = hdMapper.selectValueByTime(dateTemp, s,"今日均");
                                t.setV(aDouble==null?null:aDouble);
                            }
                            if(t.getStation().contains("河西")){
                                Optional<String> first = trendsTableParamListTemp.stream().filter(p ->p.getUseStation().contains("河西") &&  p.getUseType() == 1 && p.getUnitId() != null && p.getUnitId().equals(tableParam.getUnitId())).map(TrendsTableParam::getId).findFirst();
                                String s = StringUtils.isEmpty(first.orElse(""))?"":first.get();
                                Double aDouble = hxMapper.selectValueByTime(dateTemp, s,"今日均");
                                t.setV(aDouble==null?null:aDouble);
                            }
                            if(t.getStation().contains("渠首")){
                                Optional<String> first = trendsTableParamListTemp.stream().filter(p -> (p.getUseStation().contains("渠首") || p.getUseStation().contains("灯笼渠")) && p.getUseType() == 1 && p.getUnitId() != null && p.getUnitId().equals(tableParam.getUnitId())).map(TrendsTableParam::getId).findFirst();
                                String s = StringUtils.isEmpty(first.orElse(""))?"":first.get();
    ...
    public RestResponse useWaterTypeStatistics(UseWaterTypeStatisticsReq req) {
        ...
        if(req.getStation().equals("楼庄子水库")){
            ...
            if(null != statistics){
                statistics.forEach(t->t.setV(Double.valueOf(df.format(t.getV()))));
                ...
                if(StringUtils.isNotEmpty(req.getUseType())){
                    ...
                    if(req.getUseType().equals("工业")){
                        ...
                        bgTemp.forEach(t->{
                            ...
                            res.setV((t.getV()==null?0.00:Double.valueOf(df.format(t.getV()*0.7))));
                            bg.add(res);
                        });
                    ...
                    if(req.getUseType().equals("农业")){
                        ...
                        bgTemp.forEach(t->{
                            UseWaterTypeStatisticsRes res = new UseWaterTypeStatisticsRes();
                            BeanUtils.copyProperties(t,res);
                            res.setV((t.getV()==null?0.00:Double.valueOf(df.format(t.getV()*0.3))));
                            bg.add(res);
                        });
                        List<UseWaterTypeStatisticsRes> collect = bg.stream().sorted(Comparator.comparing(UseWaterTypeStatisticsRes::getRecordTime, Comparator.nullsFirst(Comparator.naturalOrder()))).collect(Collectors.toList());
                        result.put("红岩水库",collect);
                    }
                    return RestResponse.ok(result);
                }else {
                    ...
                    for(Date date : dates){
                        ...
                        for(UseWaterTypeStatisticsRes temp : collect.get(date)){
                            if(temp.getParamName().equals("八钢")){
                                aDouble += (temp.getV()==null?0.00:Double.valueOf(df.format(temp.getV()*0.7)));
                            }else {
                                aDouble += temp.getV()==null?0.00:Double.valueOf(df.format(temp.getV()));
                            }
                        }
                        res.setV(aDouble);
                    ...
                    for(Date date : dates){
                        ...
                        for(UseWaterTypeStatisticsRes temp : collect.get(date)){
                            if(temp.getParamName().equals("八钢")) {
                                aDouble += (temp.getV()==null?0.00:Double.valueOf(df.format(temp.getV()*0.3)));
                            }
                        }
                        res.setV(aDouble);
                        res.setRecordTime(date);
        ...
        if(req.getStation().equals("渠首管理站")){
            ...
            List<TrendsTableParam> qsNy = trendsTableParamList.stream().filter(t -> t.getUseStation().equals("渠首管理站农业") && t.getUseType() == 2).collect(Collectors.toList());
            List<TrendsTableParam> qsLh = trendsTableParamList.stream().filter(t -> t.getUseStation().equals("渠首管理站绿化") && t.getUseType() == 2).collect(Collectors.toList());
            List<TrendsTableParam> qsGy = trendsTableParamList.stream().filter(t -> t.getUseStation().equals("渠首管理站砂厂") && t.getUseType() == 2).collect(Collectors.toList());
            if(StringUtils.isEmpty(req.getUseType())){
                TrendsTableParam totalNyParam = qsNy.stream().filter(t -> t.getPId().equals("0") && t.getParamName().equals("合计")).collect(Collectors.toList()).get(0);
                ...
                TrendsTableParam totalLhParam = qsLh.stream().filter(t -> t.getPId().equals("0") && t.getParamName().equals("合计")).collect(Collectors.toList()).get(0);
                ...
                TrendsTableParam totalGyParam = qsGy.stream().filter(t -> t.getPId().equals("0") && t.getParamName().equals("合计")).collect(Collectors.toList()).get(0);
                req.setStationList(Arrays.asList(totalGyParam.getId()));
                List<UseWaterTypeStatisticsRes> statistics3 = this.baseMapper.statistics(req);
                if(null != statistics3 && statistics3.size()>0){
                    statistics3.forEach(t->t.setParamName("工业"));
                    collect.put("工业",statistics3);
                }
                List<TrendsTableParam> qsTableList = trendsTableParamListTemp.stream().filter(t -> t.getUseStation().equals("渠首管理站")
                        && t.getUseType() == 1).collect(Collectors.toList());
                TrendsTableParam stParent = qsTableList.stream().filter(t -> t.getParamName().equals("生态") && t.getPId().equals("0")).findFirst().get();
                TrendsTableParam param = qsTableList.stream().filter(t -> t.getPId().equals(stParent.getId()) && t.getParamName().equals("合计")).findFirst().get();
                List<DayWaterSituationStatisticsTableQs> dayWaterSituationStatisticsTableQs = dayWaterSituationStatisticsTableQsMapper.selectListByTimeForStatistics(Arrays.asList(param.getId()), req.getStartTime(), req.getEndTime());
                if(null != dayWaterSituationStatisticsTableQs && dayWaterSituationStatisticsTableQs.size()>0){
                    List<UseWaterTypeStatisticsRes> statistics4 = new ArrayList<>();
                    for(DayWaterSituationStatisticsTableQs qs:dayWaterSituationStatisticsTableQs){
                        UseWaterTypeStatisticsRes res = new UseWaterTypeStatisticsRes();
                        res.setV(qs.getV());
                        res.setRecordTime(qs.getRecordTime());
                        res.setParamName("生态用水");
                        statistics4.add(res);
                    }
                    collect.put("生态用水",statistics4);
                }
                if(collect.size()>0){
                    return RestResponse.ok(collect);
                }else {
                ...
                if(req.getUseType().equals("农业")){
                    req.setStationList(getTableIds(qsNy));
                ...
                if(req.getUseType().equals("绿化")){
                    req.setStationList(getTableIds(qsLh));
                    List<UseWaterTypeStatisticsRes> statistics = this.baseMapper.statistics(req);
                    if(null != statistics && statistics.size()>0){
                        Map<String, List<UseWaterTypeStatisticsRes>> collect1 = statistics.stream().collect(Collectors.groupingBy(UseWaterTypeStatisticsRes::getParamName));
                        return RestResponse.ok(collect1);
                ...
                if(req.getUseType().equals("工业")){
                    req.setStationList(getTableIds(qsGy));
                    List<UseWaterTypeStatisticsRes> statistics = this.baseMapper.statistics(req);
                    if(null != statistics && statistics.size()>0){
                        Map<String, List<UseWaterTypeStatisticsRes>> collect1 = statistics.stream().collect(Collectors.groupingBy(UseWaterTypeStatisticsRes::getParamName));
                        return RestResponse.ok(collect1);
                ...
                if(req.getUseType().equals("生态用水")){
                    Map<String, List<UseWaterTypeStatisticsRes>> collect1 = new HashMap<>();
                    List<TrendsTableParam> qsTableList = trendsTableParamListTemp.stream().filter(t -> t.getUseStation().equals("渠首管理站")
                            && t.getUseType() == 1).collect(Collectors.toList());
                    TrendsTableParam stParent = qsTableList.stream().filter(t -> t.getParamName().equals("生态") && t.getPId().equals("0")).findFirst().get();
                    List<String> strings = qsTableList.stream().filter(t -> t.getPId().equals(stParent.getId()) && !t.getParamName().equals("合计")).map(TrendsTableParam::getId).collect(Collectors.toList());
                    List<DayWaterSituationStatisticsTableQs> dayWaterSituationStatisticsTableQs = dayWaterSituationStatisticsTableQsMapper.selectListByTimeForStatistics(strings, req.getStartTime(), req.getEndTime());
                    Map<String, List<DayWaterSituationStatisticsTableQs>> collectTemp = dayWaterSituationStatisticsTableQs.stream().collect(Collectors.groupingBy(DayWaterSituationStatisticsTableQs::getTableHeadId));
                    for(String s:strings){
                        if(null != collectTemp.get(s) && !collectTemp.get(s).isEmpty()){
                            List<UseWaterTypeStatisticsRes> resList = new ArrayList<>();
                            for(DayWaterSituationStatisticsTableQs qs:collectTemp.get(s)){
                                UseWaterTypeStatisticsRes res = new UseWaterTypeStatisticsRes();
                                res.setRecordTime(qs.getRecordTime());
                                res.setV(qs.getV());
                                res.setParamName((String)redisUtil.get("trendsTableParam:name:"+s));
                                resList.add(res);
                            }
                            collect1.put((String)redisUtil.get("trendsTableParam:name:"+s),resList);
                        }
                    }
                    if(collect1.isEmpty()){
                        return RestResponse.no("blank");
        ...
        if(req.getStation().equals("河西管理站")){
            Map<String, List<UseWaterTypeStatisticsRes>> collect = new HashMap<>();
            List<TrendsTableParam> hxNy = trendsTableParamList.stream().filter(t -> t.getUseType() == 2 && t.getUseStation().equals("河西管理站农业")).collect(Collectors.toList());
            List<TrendsTableParam> hxLh = trendsTableParamList.stream().filter(t -> t.getUseType() == 2 && t.getUseStation().equals("河西管理站绿化")).collect(Collectors.toList());
            if(StringUtils.isEmpty(req.getUseType())){
                TrendsTableParam totalNyParam = hxNy.stream().filter(t -> t.getPId().equals("0") && t.getParamName().equals("合计")).collect(Collectors.toList()).get(0);
                req.setStationList(Arrays.asList(totalNyParam.getId()));
                List<UseWaterTypeStatisticsRes> statistics1 = this.baseMapper.statistics(req);
                if(null != statistics1 && statistics1.size()>0){
                    statistics1.forEach(t->t.setParamName("农业"));
                ...
                TrendsTableParam totalLhParam = hxLh.stream().filter(t -> t.getPId().equals("0") && t.getParamName().equals("合计")).collect(Collectors.toList()).get(0);
                req.setStationList(Arrays.asList(totalLhParam.getId()));
                List<UseWaterTypeStatisticsRes> statistics2 = this.baseMapper.statistics(req);
                if(null != statistics2 && statistics2.size()>0){
                    statistics2.forEach(t->t.setParamName("绿化"));
                ...
                if(req.getUseType().equals("农业")){
                    req.setStationList(getTableIds(hxNy));
                    List<UseWaterTypeStatisticsRes> statistics = this.baseMapper.statistics(req);
                    if(null != statistics && statistics.size()>0){
                        Map<String, List<UseWaterTypeStatisticsRes>> collect1 = statistics.stream().collect(Collectors.groupingBy(UseWaterTypeStatisticsRes::getParamName));
                        return RestResponse.ok(collect1);
                ...
                if(req.getUseType().equals("绿化")){
                    req.setStationList(getTableIds(hxLh));
                    List<UseWaterTypeStatisticsRes> statistics = this.baseMapper.statistics(req);
                    if(null != statistics && statistics.size()>0){
                        Map<String, List<UseWaterTypeStatisticsRes>> collect1 = statistics.stream().collect(Collectors.groupingBy(UseWaterTypeStatisticsRes::getParamName));
                        return RestResponse.ok(collect1);
    ...
    public RestResponse selectTotalForIndex(String stationName,String time) {
        ...
        List<WaterFeeStatisticsTotal> waterFeeStatisticsTotalList = waterFeeStatisticsTotalService.lambdaQuery().in(WaterFeeStatisticsTotal::getTableHeadId, strings).eq(WaterFeeStatisticsTotal::getYear, year).eq(WaterFeeStatisticsTotal::getMonth, month).
                eq(WaterFeeStatisticsTotal::getTenDays, tenDays).list();
        for(TrendsTableParamVo vo:resultParamVoList){
            ...
            Double aDouble = waterFeeStatisticsTotalList.stream().filter(t -> t.getTableHeadId().equals(vo.getId())).map(WaterFeeStatisticsTotal::getAccumulatedWaterVolume).reduce(Double::sum).orElse(0.00);
    ...
    private Map<String,String> getTimeRange(Integer year, Integer month, String tenDays){
        ...
        if(tenDays.equals("下旬")){
            Integer yearMonth = YearMonth.of(year, month).lengthOfMonth();
            endTime = endTime + "-"+yearMonth;
        }

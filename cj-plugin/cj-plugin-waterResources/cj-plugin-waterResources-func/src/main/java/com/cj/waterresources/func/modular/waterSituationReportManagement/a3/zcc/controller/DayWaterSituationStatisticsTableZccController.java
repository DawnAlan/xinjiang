...
public class DayWaterSituationStatisticsTableZccController{
    ...
    @ApiOperation("制材厂日水情统计表新增")
    @CommonLog("制材厂日水情统计表新增")
    @PostMapping("/add")
    ...
    @ApiOperation("制材厂日水情统计表查询列表")
    @CommonLog("制材厂日水情统计表查询列表")
    ...
    @ApiOperation("制材厂日水情统计表删除")
    @CommonLog("制材厂日水情统计表删除")
    @GetMapping("/delete")
    ...
    @ApiOperation("制材厂日水情统计表修改")
    @CommonLog("制材厂日水情统计表修改")
    @PostMapping("/update")

...
public class DayWaterSituationStatisticsTableTthServiceImpl extends ServiceImpl<DayWaterSituationStatisticsTableTthMapper, DayWaterSituationStatisticsTableTth> implements DayWaterSituationStatisticsTableTthService {
    ...
    public RestResponse add(List<DayWaterSituationStatisticsTableTth> dayWaterSituationStatisticsTableTthList) {
        ...
        if(null != tempList && tempList.size()==0){
            ...
            List<DayWaterSituationStatisticsTableTth> yesterdayList = this.baseMapper.selectList(yesterday);
            Map<String, List<DayWaterSituationStatisticsTableTth>> collect = yesterdayList.stream().collect(Collectors.groupingBy(DayWaterSituationStatisticsTableTth::getTableHeadId));
            ...
            for(String s:strings){
                ...
                yesterdayBean.setV(collect.get(s).stream().filter(t->t.getV()!=null).map(DayWaterSituationStatisticsTableTth::getV).reduce(Double::sum).orElse(0.00));

...
public class WaterResourceHomePageController {
    ...
    @ApiOperation("水资源首页今日概览")
    @CommonLog(value = "水资源首页今日概览")
    @GetMapping("/overview")
    ...
    @ApiOperation("水资源首页获取水情站分类")
    @CommonLog(value = "水资源首页获取水情站分类")
    ...
    @ApiOperation("水资源首页今日水情")
    @CommonLog(value = "水资源首页今日水情")
    ...
    @ApiOperation("水资源首页水库概览")
    @CommonLog(value = "水资源首页水库概览")

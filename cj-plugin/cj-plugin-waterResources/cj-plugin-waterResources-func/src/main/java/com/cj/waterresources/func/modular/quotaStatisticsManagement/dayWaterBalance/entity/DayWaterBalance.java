package com.cj.waterresources.func.modular.quotaStatisticsManagement.dayWaterBalance.entity;
...
/**
 * 日水量平衡表(DayWaterBalance)表实体类
 *
 * @author makejava
 * @since 2023-12-22 18:39:37
 */
@Data
public class DayWaterBalance extends Model<DayWaterBalance> {
    //主键ID

...
public class DayWaterSituationStatisticsTableQsLhController {
    ...
    @ApiOperation("灯笼渠绿化日水情统计表新增")
    @CommonLog("灯笼渠绿化日水情统计表新增")
    @PostMapping("/add")
    ...
    @ApiOperation("灯笼渠绿化日水情统计表查询列表")
    @CommonLog("灯笼渠绿化日水情统计表查询列表")
    ...
    @ApiOperation("灯笼渠绿化日水情统计表删除")
    @CommonLog("灯笼渠绿化日水情统计表删除")
    @GetMapping("/delete")
    ...
    @ApiOperation("灯笼渠绿化日水情统计表修改")
    @CommonLog("灯笼渠绿化日水情统计表修改")
    @PostMapping("/update")

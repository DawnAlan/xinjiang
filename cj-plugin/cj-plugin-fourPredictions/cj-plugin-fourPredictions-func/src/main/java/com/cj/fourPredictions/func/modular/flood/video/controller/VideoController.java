...
public class VideoController {
    ...
    @ApiOperation(value="分页获取区域列表", notes="分页获取区域列表")
    ...
    @ApiOperation(value="根据区域编号获取下级监控点列表", notes="根据区域编号获取下级监控点列表")
    ...
    @ApiOperation(value="获取监控点预览取流URL", notes="获取监控点预览取流URL")
    ...
    @ApiOperation(value="分页禁获取监控点资源", notes="分页禁获取监控点资源")

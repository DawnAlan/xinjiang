...
public interface IrrigatedPlatformDataInfoService extends IService<IrrigatedPlatformDataInfo> {
    ...
    List<IrrigatedPlatformDataInfo> selectOneByConditionByTime(String startTime,String endTime);
    ...
    List<IrrigatedPlatformDataInfo> getRealTimeWaterLevel(String station,String time);

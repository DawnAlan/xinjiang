...
/**
 * WpdStRsvrRId entity. @author Li Qi by MyEclipse Persistence Tools
 */
@Embeddable

public class WpdStRsvrRId implements java.io.Serializable {
	...
	/** full constructor */
	public WpdStRsvrRId(LocalDateTime tm, String stcd) {
		this.tm = tm;
		this.stcd = stcd;
	}
	...
	@Column(name = "STCD", nullable = false, length = 200)
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof WpdStRsvrRId))
			return false;
		WpdStRsvrRId castOther = (WpdStRsvrRId) other;

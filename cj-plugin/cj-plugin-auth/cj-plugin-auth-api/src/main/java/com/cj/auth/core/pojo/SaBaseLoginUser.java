...
public abstract class SaBaseLoginUser {
    ...
    /** 员工编号 */
    @ApiModelProperty(value = "员工编号", position = 29)
    private String empNo;

    /** 入职日期 */
    @ApiModelProperty(value = "入职日期", position = 30)
    private String entryDate;

    /** 组织id */
    @ApiModelProperty(value = "组织id", position = 31)
    private String orgId;

    /** 组织名称 */
    @ApiModelProperty(value = "组织名称", position = 32)
    ...
    /** 职位名称 */
    @ApiModelProperty(value = "职位名称", position = 34)

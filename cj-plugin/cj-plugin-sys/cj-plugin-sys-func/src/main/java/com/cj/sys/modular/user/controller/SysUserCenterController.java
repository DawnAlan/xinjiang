...
package com.cj.sys.modular.user.controller;
...
import com.cj.sys.modular.user.result.SysUserMessageDetailResult;
import com.cj.sys.modular.user.result.SysUserMessageResult;
import com.cj.sys.modular.user.result.SysUserPicValidCodeResult;
import com.cj.sys.modular.user.result.SysUserPositionResult;
